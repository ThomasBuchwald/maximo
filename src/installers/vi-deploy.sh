...
wget -nv https://raw.githubusercontent.com/$repoName/maximo/$branchName/src/machinesets/worker-vi-tesla.yaml -O /tmp/OCPInstall/worker-vi-tesla.yaml
...
sudo -E /tmp/OCPInstall/oc apply -f https://raw.githubusercontent.com/$repoName/maximo/$branchName/src/nfd/nfd-operator.yaml
...
wget -nv -qO- https://raw.githubusercontent.com/$repoName/maximo/$branchName/src/vi/nv-operator.yaml | envsubst | sudo -E /tmp/OCPInstall/oc apply -f -
