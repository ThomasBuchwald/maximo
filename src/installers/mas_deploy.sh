...
# Install catalogs
oc apply -f https://raw.githubusercontent.com/ThomasBuchwald/maximo/$branchName/src/operatorcatalogs/catalog-source.yaml

# Set up all the operators
oc apply -f https://raw.githubusercontent.com/ThomasBuchwald/maximo/$branchName/src/servicebinding/service-binding-operator.yaml
# Wait
...
oc apply -f https://raw.githubusercontent.com/ThomasBuchwald/maximo/$branchName/src/sls/sls-operator.yaml
...
wget -nv https://raw.githubusercontent.com/ThomasBuchwald/maximo/$branchName/src/mas/mas-operator.yaml -O /tmp/mas-operator.yaml
...
oc apply -f https://raw.githubusercontent.com/ThomasBuchwald/maximo/$branchName/src/bas/bas-operator.yaml
oc apply -f https://raw.githubusercontent.com/ThomasBuchwald/maximo/$branchName/src/strimzi/strimzi-operator.yaml
...
oc apply -f https://raw.githubusercontent.com/ThomasBuchwald/maximo/$branchName/src/bas/bas-service.yaml
...
oc apply -f https://raw.githubusercontent.com/ThomasBuchwald/maximo/$branchName/src/bas/bas-api-key.yaml

echo "BAS Service Up"

oc apply -f https://raw.githubusercontent.com/ThomasBuchwald/maximo/$branchName/src/sls/sls-service.yaml
...
oc apply -f https://raw.githubusercontent.com/ThomasBuchwald/maximo/$branchName/src/strimzi/strimzi-service.yaml
...
#deploy mas
wget -nv https://raw.githubusercontent.com/ThomasBuchwald/maximo/$branchName/src/mas/mas-service.yaml -O /tmp/mas-service.yaml
...
kill $PID
wget -nv https://raw.githubusercontent.com/ThomasBuchwald/maximo/$branchName/src/mas/slsCfg.yaml -O /tmp/slsCfg.yaml
...
wget -nv https://raw.githubusercontent.com/ThomasBuchwald/maximo/$branchName/src/mas/basCfg.yaml -O /tmp/basCfg.yaml
...
kill $PID
wget -nv https://raw.githubusercontent.com/ThomasBuchwald/maximo/$branchName/src/mas/mongoCfg.yaml -O /tmp/mongoCfg.yaml
