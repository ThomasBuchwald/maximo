...
#Install OCP
wget -nv "https://raw.githubusercontent.com/$repoName/maximo/$branchName/src/installers/ocp_setup.sh" -O /tmp/ocp_setup.sh
...
then
    #Deploy MAS
    wget -nv "https://raw.githubusercontent.com/$repoName/maximo/$branchName/src/installers/mas_deploy.sh" -O /tmp/mas_deploy.sh
...
then
    #Deploy OCS
    wget -nv "https://raw.githubusercontent.com/$repoName/maximo/$branchName/src/installers/ocs_deploy.sh" -O /tmp/ocs_deploy.sh
...
then
    #Deploy CP4D
    wget -nv "https://raw.githubusercontent.com/$repoName/maximo/$branchName/src/installers/cp4d_deploy.sh" -O /tmp/cp4d_deploy.sh
...
then
    #Deploy VI
    wget -nv "https://raw.githubusercontent.com/$repoName/maximo/$branchName/src/installers/vi-deploy.sh" -O /tmp/vi-deploy.sh
