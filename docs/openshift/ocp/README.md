...
wget -nv https://raw.githubusercontent.com/ThoamsBuchwald/maximo/$branchName/src/ocp/install-config.yaml -O /tmp/OCPInstall/QuickCluster/install-config.yaml
